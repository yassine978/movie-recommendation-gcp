...
async def startup_event():
    ...
    try:
        ...
        if isinstance(model_data, dict):
            # Dict format: reconstruct MovieRecommender object
            ...
            # Direct MovieRecommender object
            recommender = model_data
            logger.info("✓ Model loaded directly")

        logger.info(f"✓ Model loaded successfully (RMSE: {recommender.training_metrics.get('rmse', 'N/A')})")
